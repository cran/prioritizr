...
* __Cuts portfolio__: Generate a portfolio of distinct solutions within a pre-specified optimality gap. If the _Gurobi_ optimization solver is available for solving problems, this is by far the fastest method for generating a portfolio that contains a specific number of solutions that are all within a specified distance from optimality.
```{r}
...
p31 <- solve(p31)
plot(p31, col = c("grey90", "darkgreen"), main = "Solution",
