...
test_that("invalid inputs", {
  ...
  expect_tidy_error(
    ...
    add_auto_targets(
       method = spec_rl_ecosystem_targets(
        NA_character_, "A2a", "B2", 0.15, "max", 7000, "km^2"
      )
    ) %>%
    compile(),
    "missing"
  ...
  expect_tidy_error(
    ...
    add_auto_targets(
      method = spec_rl_ecosystem_targets(
        "greg", "A2a", "B2", 0.15, "max", 7000, "km^2"
      )
    ) %>%
    compile(),
    "must"
  ...
  expect_tidy_error(
    ...
    add_auto_targets(
      method = spec_rl_ecosystem_targets(
        "CR", "A2a", NA_character_, 0.15, "max", 7000, "km^2"
      )
    ) %>%
    compile(),
    "missing"
  ...
  expect_tidy_error(
    ...
    add_auto_targets(
      method = spec_rl_ecosystem_targets(
        "CR", "A2a", "greg", 0.15, "max", 7000, "km^2"
      )
    ) %>%
    compile(),
    "must"
  ...
  expect_tidy_error(
    ...
    add_auto_targets(
      method = spec_rl_ecosystem_targets(
        "CR", "A2a", "B2", 0.15, NA_character_, 7000, "km^2"
      )
    ) %>%
    compile(),
    "missing"
  ...
  expect_tidy_error(
    ...
    add_auto_targets(
      method = spec_rl_ecosystem_targets(
        "CR", "A2a", "B2", 0.15, "max", 7000, NA_character_
      )
    ) %>%
    compile(),
    "unit"
