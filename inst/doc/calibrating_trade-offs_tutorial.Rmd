...
Let's load the packages and dataset used in this tutorial. Since this tutorial uses the _prioritizrdata R_ package along with several other _R_ packages (see below), please ensure that they are all installed. This particular dataset comprises two object: `tas_pu` and `tas_features`. Although we will briefly describe this dataset below, please refer `?prioritizrdata::tas_data` for further details.
