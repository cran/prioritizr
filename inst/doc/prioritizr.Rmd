...
# plot solution
plot(s35, col = c("grey90", "darkgreen"), main = "Solution",
...
# plot solution
plot(s36, col = c("grey90", "darkgreen"), main = "Solution",
     xlim = c(-0.1, 1.1), ylim = c(-0.1, 1.1))
...
cellStats(sim_pu_raster * s36, "sum")

# calculate how well features are represented in the solution
r36 <- feature_representation(p36, s36)
print(r36)
```
