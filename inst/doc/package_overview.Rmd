...
```{r, include = FALSE}
# wrapper for printing problem objects
print_problem <- function(x) {
  if (interactive()) {
    print(x)
    return(invisible())
  }
